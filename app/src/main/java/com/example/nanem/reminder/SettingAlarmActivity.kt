package com.example.nanem.reminder

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.view.View
import com.example.nanem.R
import com.example.nanem.databinding.ActivitySettingAlarmBinding
import java.text.SimpleDateFormat
import java.util.*

class SettingAlarmActivity : AppCompatActivity(), View.OnClickListener, DatePickerFragment.DialogDateListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding?.tvOnceTime?.setOnClickListener(this)
        binding?.tvOnceDate?.setOnClickListener(this)
